  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 group
                 w-14 h-14 rounded-full bg-whatsapp hover:bg-whatsapp-dark
    ...
    >
      ...
      <span
        className="pointer-events-none absolute right-16 whitespace-nowrap
                   bg-neutral-900 text-white text-xs font-body px-3 py-1.5
                   rounded-full opacity-0 group-hover:opacity-100
                   transition-opacity duration-200 hidden lg:block"
        aria-hidden="true"
      >
        Chatea por WhatsApp
      </span>
